...
Generated 2026-09-10 20:05 UTC by `benchmarks/compare_pyvinecopulib.py`.
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| rscopulas (AIC) | 3.146 | 2608.9 | 2607.6 | 10 | 0.0232 (0.23) | 0.0548 |
| pyvinecopulib (BIC) | 1.710 | 2608.9 | 2607.6 | 10 | 0.0232 (0.23) | 0.0493 |
| rscopulas (BIC) | 3.129 | 2608.9 | 2607.6 | 10 | 0.0232 (0.23) | 0.0548 |
| truth (simulating vine) | – | 2606.3 | 2609.0 | – | 0.0208 (0.35) | 0.0355 |

Fit-time ratio rscopulas (AIC) / pyvinecopulib (BIC): **1.8x**. Out-of-sample log-likelihood gap to the truth: rscopulas (AIC) -1.4, pyvinecopulib (BIC) -1.4, rscopulas (BIC) -1.4.
...
| --- | --- | --- | --- | --- |
| (0, 2) | gaussian [0.65] | gaussian [0.65] | gaussian [0.65] | gaussian [0.65] |
| (1, 2) | gaussian [0.5] | – | – | – |
| (1, 3) | gaussian [-0.6] | gaussian [-0.601] | gaussian [-0.601] | gaussian [-0.601] |
| (1, 4) | – | gaussian [0.604] | gaussian [0.604] | gaussian [0.604] |
| (2, 4) | gaussian [0.75] | gaussian [0.765] | gaussian [0.765] | gaussian [0.765] |

## mixed_rvine_5d (d = 5, n_train = 2000, n_test = 2000)

| Model | Fit time (s) | Log-lik train | Log-lik test | Params | KS max (p) | Spearman max |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| rscopulas (AIC) | 3.433 | 4385.4 | 4450.8 | 14 | 0.0287 (0.07) | 0.1045 |
| pyvinecopulib (BIC) | 1.257 | 4378.7 | 4443.8 | 13 | 0.0212 (0.33) | 0.0835 |
| rscopulas (BIC) | 3.421 | 4378.7 | 4443.8 | 13 | 0.0287 (0.07) | 0.1028 |
| truth (simulating vine) | – | 4595.8 | 4644.5 | – | 0.0192 (0.45) | 0.0375 |

Fit-time ratio rscopulas (AIC) / pyvinecopulib (BIC): **2.7x**. Out-of-sample log-likelihood gap to the truth: rscopulas (AIC) -193.8, pyvinecopulib (BIC) -200.7, rscopulas (BIC) -200.7.

Selected first-tree edges (variables are 0-based; `r` = rotation in degrees):

| Pair | Truth | rscopulas (AIC) | pyvinecopulib (BIC) | rscopulas (BIC) |
| --- | --- | --- | --- | --- |
| (0, 1) | – | student_t [0.63, 11.5] | student_t [0.63, 11.5] | student_t [0.63, 11.5] |
| (0, 2) | student_t [0.6, 4] | – | – | – |
| (0, 4) | gumbel r180 [2.5] | bb1 r180 [0.1, 2.44] | gumbel r180 [2.55] | gumbel r180 [2.55] |
...
| Model | Fit time (s) | Log-lik train | Log-lik test | Params | KS max (p) | Spearman max |
| --- | ---: | ---: | ---: | ---: | ---: | ---: |
| rscopulas (AIC) | 6.540 | 7732.0 | 7407.1 | 35 | 0.0384 (0.01) | 0.0594 |
| pyvinecopulib (BIC) | 4.145 | 7708.7 | 7391.2 | 30 | 0.0292 (0.06) | 0.0940 |
| rscopulas (BIC) | 6.533 | 7708.7 | 7391.2 | 30 | 0.0373 (0.01) | 0.0804 |
| truth (simulating vine) | – | 7941.2 | 7690.2 | – | 0.0284 (0.08) | 0.0612 |

Fit-time ratio rscopulas (AIC) / pyvinecopulib (BIC): **1.6x**. Out-of-sample log-likelihood gap to the truth: rscopulas (AIC) -283.1, pyvinecopulib (BIC) -299.0, rscopulas (BIC) -299.0.
...
| (2, 5) | – | bb1 r180 [0.155, 1.66] | bb1 r180 [0.155, 1.66] | bb1 r180 [0.155, 1.66] |
| (2, 6) | gumbel r180 [2.2] | gumbel r180 [2.14] | gumbel r180 [2.14] | gumbel r180 [2.14] |
| (2, 7) | student_t [-0.55, 6] | – | – | – |
| (3, 7) | student_t [0.7, 4] | student_t [0.687, 3.79] | student_t [0.687, 3.79] | student_t [0.687, 3.79] |
| (5, 7) | gumbel r90 [2] | bb1 r90 [0.0582, 1.97] | gumbel r90 [2.02] | gumbel r90 [2.02] |
