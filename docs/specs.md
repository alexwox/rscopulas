...
**HAC:** density and sampling are not validated to the same standard for every tree shape; see [hac.md](hac.md) (joint `log_pdf` versus explicit `composite_log_pdf`, **mixed-family sampling** limitations).
